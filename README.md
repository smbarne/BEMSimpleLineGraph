# BEMSimpleLineGraph - iOS 9 Beta Branch
...
- Requires iOS 8 or later. The sample project is optimized for iOS 9.
...
|:--------------------:	|:-------------------------------:	|:--------------------------------:	|
|       iOS 9.0 Beta 4        	|            iOS 8.0             	|             iOS 7.0              	|
|     Xcode 7.0 Beta 4      	|          Xcode 6.3            	|           Xcode 6.0            	|
|      LLVM 7.0        	|             LLVM 6.1            	|             LLVM 5.0             	|
